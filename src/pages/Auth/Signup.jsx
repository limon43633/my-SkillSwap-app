        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-xl shadow-xl p-6 space-y-6 border border-white/20">
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <FaImage className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 text-sm" />
                <input
                  type="url"
                  name="photoURL"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full pl-9 pr-10 py-2 bg-white/5 border rounded-md text-white placeholder-gray-400 focus:ring-2 outline-none transition-all text-sm ${
                    errors.password ? 'border-red-500 focus:ring-red-500/50' : 'border-gray-500/50 focus:border-blue-500 focus:ring-blue-500/50'
                  }`}
